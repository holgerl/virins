...
We looked at the available technology for connecting a high definition camera to a PC and reading the images from it. We studied the properties of infrared light. We looked at and tested the Nintendo Wii game console and its Wiimotes. Lastly, potential areas of use for a solution was described.
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.3\textwidth]{graphics/wiimote2.png}
...
\section{Implementation}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.45\textwidth]{graphics/hdcam.jpg}
...
\section{Acknowledgements}
	...
	We would like to thank virtual reality village chief Egil Tjåland for an inspiring enthusiasm. Thorvald Natvig and Knut Bakke are to be thanked for their technical assistance. And the EiT learning assistants are appreciated for their guidance and facilitation.

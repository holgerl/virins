\section{Matematikken bak trackingen (Vegar)}
    ...
    innebygd optisk sensor og tracking av infrarøde lys, vurdert. Nintendo Wiimote har en oppløsning på 786 432 piksler. Tidlige tester antyder at oppløsningen til Wiimote er i nedre sjikt av hva som er
    ...
    parametrene som er nødvendig for å få riktig perspektivprojeksjon i en 3d-scene.
    ...
    utgjør beregningsgrunnlaget. Det finnes mer kompliserte algoritmer som er iterative(ikke på lukket form), og gir ikke eksakt(men veldig nære)       løsninger.
    ...
    De følgende ligningene benyttes for å korrigere perspektivet(regne ut koordinatene til nærplanet) når øyet er flyttet til posisjonen x,y,z. Figur \ref{fig:perspektivkorreksjon} viser denne sammenhengen.

...
\section{Implementasjon av løsningen}
	...
	\subsection{Implementasjon av programvaren}
		...
		Progamvaren består av punktfinneren, posisjonsfinneren og 3D-viseren. De er alle skrevet i Java, men 3D-viseren bruker et bibliotek implementert i C for selve visning av 3D-grafikken. Figur \ref{fig:holger_class_diagram} viser et klassediagram av punktfinneren og figur \ref{fig:vegar_class_diagram} viser posisjonsfinneren og 3D-viseren.
		
		\subsubsection{Punktfinneren (Holger)}
		
			Figur \ref{fig:holger_class_diagram} viser et klassediagram av punktfinneren.
